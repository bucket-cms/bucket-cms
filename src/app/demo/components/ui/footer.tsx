...
const Footer = () => {
  return (
    <footer className="pt-8 pb-12 sm:px-8 border-t bg-gradient-to-b from-gray-50 via-white opacity-70 to-white">
      <div className="max-w-[1024px] px-4 mx-auto flex flex-col sm:flex-row justify-between">
        ...
        <div className="relative sm:left-16 flex justify-center py-6 pl-4 sm:block sm:p-0">
          <GithubLink />
        </div>
      </div>
    </footer>
